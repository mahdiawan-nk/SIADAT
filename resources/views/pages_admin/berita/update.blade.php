<div class="modal fade" id="update-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
        <form class="modal-content" method="POST" id="form-berita-update">
            @csrf
            @method('PUT')
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="isi" id="e-isi" class="form-control editor" cols="30" rows="10"></textarea>
                </div>
                <div class="form-group">
                    <label for="judul">Thumbnail</label>
                    <div class="input-group mb-3 upload-file" style="cursor: pointer">
                        <span class="input-group-text">Upload File</span>
                        <input type="text" name="thumbnail" class="form-control" placeholder="Upload Files"

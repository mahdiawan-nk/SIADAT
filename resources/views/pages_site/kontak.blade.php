                ...
                <div class="contact-form bg-light p-5">
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-sm-12 fs-3 bg-white ps-4 py-2">
                            <i class="fa-regular fa-envelope me-2"></i><a href="mailto:someone@example.com">{{ $data->surel }}</a>
                        </div>
                        <div class="col-12 col-sm-12 fs-3 bg-white ps-4 py-2">
                            <i class="fa-solid fa-phone me-2"></i><a href="">{{ $data->telephone }}</a>
                        </div>
                        <div class="col-12 col-sm-12 fs-3 bg-white ps-4 py-2">
                            <i class="fa-solid fa-location-dot me-2"></i><a href="">{{ $data->alamat }}</a>
                        </div>
                    </div>
                </div>
            </div>
